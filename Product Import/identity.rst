...
The other elements, :code:`gtin`, :code:`mpn` and :code:`sku` are product data that is **not** used for identification during processing, but are persisted if provided.
...
The restrictions are more lenient for the elements :code:`mpn` and :code:`sku`. If specified, 1 |--| 50 characters of any kind is permitted.
